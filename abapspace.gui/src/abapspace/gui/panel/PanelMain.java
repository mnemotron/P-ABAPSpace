...
public class PanelMain extends JPanel {
			...
			groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addComponent(getPanelST(), GroupLayout.DEFAULT_SIZE, 870, Short.MAX_VALUE)
						.addComponent(getPanelPreset(), Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 880, Short.MAX_VALUE))
					.addContainerGap())
		);
	...
	private JPanel getPanelPreset() {
		if (panelPreset == null) {
			...
			panelPreset.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 255)), "Preset", TitledBorder.LEADING, TitledBorder.TOP, null, Color.BLUE));
			GroupLayout gl_panelPreset = new GroupLayout(panelPreset);
			gl_panelPreset.setHorizontalGroup(
				gl_panelPreset.createParallelGroup(Alignment.LEADING)
					.addGroup(gl_panelPreset.createSequentialGroup()
						.addContainerGap()
						.addGroup(gl_panelPreset.createParallelGroup(Alignment.LEADING)
							...
							.addComponent(getLblPreset()))
						.addContainerGap())
			);
			gl_panelPreset.setVerticalGroup(
				gl_panelPreset.createParallelGroup(Alignment.LEADING)
					.addGroup(gl_panelPreset.createSequentialGroup()
						.addGap(14)
						.addComponent(getLblPresetDir())
						...
						.addGroup(gl_panelPreset.createParallelGroup(Alignment.BASELINE)
							.addComponent(getTxfPresetDir(), GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addComponent(getBtnPresetDir()))
						.addGap(12)
						.addComponent(getLblPreset())
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(getCbPreset(), GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
	...
	private JTextField getTxfPresetDir() {
	...
	private JPanel getPanelST() {
		if (panelST == null) {
			panelST = new JPanel();
			panelST.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 255)), "Source/Target", TitledBorder.LEADING, TitledBorder.TOP, null, Color.BLUE));
			GroupLayout gl_panelST = new GroupLayout(panelST);
			gl_panelST.setHorizontalGroup(
				gl_panelST.createParallelGroup(Alignment.LEADING)
					.addGroup(gl_panelST.createSequentialGroup()
						.addContainerGap()
						.addGroup(gl_panelST.createParallelGroup(Alignment.LEADING)
							.addComponent(getLblSourceDir())
							...
							.addGroup(Alignment.TRAILING, gl_panelST.createSequentialGroup()
								.addGroup(gl_panelST.createParallelGroup(Alignment.TRAILING)
									.addComponent(getTxtTargetDir(), GroupLayout.DEFAULT_SIZE, 801, Short.MAX_VALUE)
									.addComponent(getTxtSourceDir(), GroupLayout.DEFAULT_SIZE, 801, Short.MAX_VALUE))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_panelST.createParallelGroup(Alignment.LEADING)
				...
				gl_panelST.createParallelGroup(Alignment.LEADING)
					.addGroup(gl_panelST.createSequentialGroup()
						...
						.addGroup(gl_panelST.createParallelGroup(Alignment.BASELINE)
							.addComponent(getTxtSourceDir(), GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addComponent(getBtnSourceDir()))
						.addGap(14)
						.addComponent(getLblTargetDir())
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_panelST.createParallelGroup(Alignment.BASELINE)
							.addComponent(getTxtTargetDir(), GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
	...
	private JTextField getTxtSourceDir() {
	...
	private JTextField getTxtTargetDir() {
